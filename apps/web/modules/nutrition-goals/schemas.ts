...
// Main nutrition goals schema - single source of truth
...
export const CreateNutritionGoalsPayloadSchema = NutritionGoalsSchema.omit({
  id: true,
  user_id: true,
  created_at: true,
  updated_at: true,
...
export type NutritionGoalsFormData = CreateNutritionGoalsPayload & { id?: string };
...
// Response types
export type CreateNutritionGoalsResponse = NutritionGoals;
export type UpdateNutritionGoalsResponse = NutritionGoals;
